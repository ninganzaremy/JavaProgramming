...
public class JavaEnums {
    public static void main(String[] args) {
        ...
        //The enum type has a values() method, which returns an array of all enum constants. This method is useful
        // when you want to loop through the constants of an enum:
